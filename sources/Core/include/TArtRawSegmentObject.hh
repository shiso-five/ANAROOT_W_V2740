...
class TArtRawSegmentObject : public TNamed
{
 public: 
  ...
  virtual void PutV2740Data(TArtRawV2740DataObject * indata){
    v2740data_array.push_back(indata);
    return;
  }
  virtual TArtRawV2740DataObject * GetV2740Data(int nn){ 
    return v2740data_array[nn];
  }
  virtual int GetNumV2740Data(){return v2740data_array.size();}  
 ...
 protected:
  ...
  std::vector <TArtRawV2740DataObject*> v2740data_array;  
